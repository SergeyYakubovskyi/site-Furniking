(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-thumbs")) new swiper_core_Swiper(".swiper-thumbs", {
            slidesPerView: 3,
            spaceBetween: 25,
            direction: "vertical",
            breakpoints: {
        ...
        if (document.querySelector(".top-collection__slider")) new swiper_core_Swiper(".top-collection__slider", {
            modules: [ Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".swiper-product")) new swiper_core_Swiper(".swiper-product", {
            ...
            pagination: {
                ...
                renderFraction: function(currentClass, totalClass) {
                    return "Page" + '<span class="' + currentClass + '"></span>' + "of" + '<span class="' + totalClass + '"></span>';
                }
            },
            navigation: {
    ...
    function startTimer(endtime, timer) {
        const daysSpan = timer.querySelector(".timer__days");
        const hoursSpan = timer.querySelector(".timer__hours");
        const minutesSpan = timer.querySelector(".timer__minutes");
        const secondsSpan = timer.querySelector(".timer__seconds");
        ...
        updateTimer();
        const timeinterval = setInterval(updateTimer, 1e3);
    }
    const timers = document.querySelectorAll(".timer");
    const endtime1 = new Date(Date.parse(new Date) + 10 * 24 * 60 * 60 * 1e3);
    const endtime2 = new Date(Date.parse(new Date) + 15 * 24 * 60 * 60 * 1e3);
    startTimer(endtime1, timers[0]);
    startTimer(endtime2, timers[1]);
    window["FLS"] = true;
    isWebp();
    spollers();
})();